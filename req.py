...
print("Log in successful, yoinking session")
...
document.querySelectorAll(
  ...
  )getAttribute("data-activities-id")
  """

# for code in [{"code": "344050"}]:
#     #                                                                        #######
#     req = requests.post("https://checkin.york.ac.uk/api/selfregistration/2815827/present", headers={
...
#
#
#     print(f"{code['code']} - {req.status_code}")
